  ...
  return (
    ...
    >
      <PageTransitionLink
        ...
        className={cn(
          'interactable',
          'group-hover:text-hover flex items-center gap-x-20 !text-link-xxl',
          { 'hover:text-hover text-red-active': pathName === href },
        )}
      >
        ...
        <svg
          width="1em"
          height="1em"
          className="text-hover scale-[.65] opacity-0 transition-opacity duration-500 group-hover:opacity-100"
          viewBox="0 0 91 91"
          fill="none"
