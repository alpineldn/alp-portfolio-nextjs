...
import ListLayout from '../../common/project-layouts/ListLayout/ListLayout';
import { AnimatePresence, useScroll, useTransform } from 'framer-motion';
import GridLayout from '../../common/project-layouts/GridLayout/GridLayout';
    ...
    <section className="relative z-[1] bg-white" ref={container}>
      <div className="mx-auto max-w-[1536px] space-y-20 pt-[37px]">
        ...
        <AnimatePresence mode="wait">
          {viewMode === 'list' && <ListLayout projects={projects} />}
          {viewMode === 'grid' && <GridLayout projects={projects} />}
        </AnimatePresence>
      </div>
