...
const Project: React.FC<ProjectProps> = ({ index, manageModal, title }) => {
  return (
    <div
      ...
      className="group flex w-full cursor-pointer items-center justify-between border-t border-solid border-t-[rgb(201,201,201)] px-[100px] py-[50px] transition-all duration-200 last:border-b last:border-b-[rgb(201,201,201)] hover:opacity-50"
    >
