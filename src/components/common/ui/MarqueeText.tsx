  ...
  return (
    ...
    >
      ...
      <div className={cn('w-min overflow-hidden', innerClassName)}>
        <div ref={marqueeRef} className="marquee flex h-full">
          <div ref={contentRef} className="flex h-full w-full flex-1">
            <div className="link-1 flex flex-1 items-start justify-center gap-x-2 whitespace-nowrap pl-3 pr-1.5 text-center tracking-wider transition-[letter-spacing] duration-500 group-hover:tracking-[0.15em]">
              {children}
            </div>
          </div>
        </div>
